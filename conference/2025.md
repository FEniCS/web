...
The [OVpay app](https://www.ovpay.nl/en/app) can show a a detailed travel history, if required
e.g. for reimbursement. Trip details for a specific payment can also be retrieved
[zelfregelen.ovpay.nl/reisoverzicht](https://zelfregelen.ovpay.nl/reisoverzicht).
